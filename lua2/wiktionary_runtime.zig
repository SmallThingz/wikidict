...
const stripDecodedComments = preprocess.stripDecodedComments;
const transcludeDecodedAlloc = preprocess.transcludeDecodedAlloc;
const findTemplateEnd = preprocess.findTemplateEnd;
const findParamEnd = preprocess.findParamEnd;
const findTopDelimiter = preprocess.findTopDelimiter;
const splitWikitextTop = preprocess.splitWikitextTop;
const ParameterSplit = preprocess.ParameterSplit;
const splitParameter = preprocess.splitParameter;
