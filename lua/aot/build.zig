...
const optimizer = @import("../compiler/optimize.zig");
const data = @import("../compiler/data.zig");
const cleanup = @import("../compiler/simplify.zig");
const verify = @import("../compiler/verify.zig");
const link_image = @import("../compiler/link_image.zig");
const link_symbols = @import("../compiler/link_symbols.zig");
const numeric_link = @import("../compiler/numeric_link.zig");
const static_fields_pass = @import("../compiler/static_fields.zig");
const module_model = @import("../compiler/module_model.zig");
const aot = @import("codegen.zig");
const aot_stats = @import("stats.zig");
const module_registry_gen = @import("module_registry_gen.zig");
